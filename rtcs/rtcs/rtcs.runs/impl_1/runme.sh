...
HD_PWD='/home/thomas/Documents/Git/Electronics/EMB/rtcs/rtcs/rtcs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rtcs_system_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source rtcs_system_wrapper.tcl -notrace
