...
HD_PWD='/home/thomas/Documents/Git/Electronics/EMB/rtcs/rtcs/rtcs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rtcs_system_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rtcs_system_wrapper.tcl
