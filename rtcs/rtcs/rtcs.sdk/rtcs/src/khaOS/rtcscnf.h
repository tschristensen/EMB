...
//--Comment out this part to use Millisec tick--//
	// Definition of system tick in Microsec.
	// #define T_TICK			100
//----------------------------------------------//
...
#define TASK1         		uart_rx_task
#define TASK2    			uart_tx_task
...
#define INIT_TASK1      	init_uart_rx_task
#define INIT_TASK2      	init_uart_tx_task
...
#define ALIVE_TASK			0
#define UART_RX_TASK		1
#define UART_TX_TASK		2
