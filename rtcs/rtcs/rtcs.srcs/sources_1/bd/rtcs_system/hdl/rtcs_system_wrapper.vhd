...
--Command     : generate_target rtcs_system_wrapper.bd
--Design      : rtcs_system_wrapper
...
end rtcs_system_wrapper;

architecture STRUCTURE of rtcs_system_wrapper is
  component rtcs_system is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
rtcs_system_i: component rtcs_system
     port map (
